...
namespace RPG.Combat
{
    ...
    ///
    /// === COMO FUNCIONA ===
    ///   1. Cliente lê o WeaponAttackProfile do item na slot Weapon.
    ///   2. O perfil determina: range, melee/projétil, físico/mágico,
    ///      multiplicador, animação, custo de mana, velocidade.
    ///   3. Cliente persegue até entrar em range, ataca em intervalos.
    ///   4. Cmd inclui range pretendido — servidor compara contra range
    ///      do perfil REAL da arma equipada.
    ///
    /// === REATIVIDADE ===
    ///   Inscrito em OnEquipmentChanged. Trocar de arma durante auto-ataque
    ///   atualiza o perfil ativo em tempo real.
    ///
    /// === MUDANÇAS DESTA VERSÃO ===
    ///   Stopping distance IDLE_STOP_DIST agora referencia
    ///   GameConstants.Movement.AGENT_IDLE_STOPPING_DISTANCE para
    ...
    public class BasicAttackSystem : NetworkBehaviour
    {
        ...
        // Constantes de tuning específicas deste sistema
