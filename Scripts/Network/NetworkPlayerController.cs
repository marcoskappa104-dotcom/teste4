...
namespace RPG.Network
{
    ...
    ///
    ///   1. CONSTANTES DE AGENT DE GameConstants.Movement:
    ///      Antes, AGENT_ACCELERATION/etc estavam duplicados aqui (com
    ///      comentário "manter em sync"). Removido — agora vêm da fonte única.
    ///
    ///   2. UIInputUtils CENTRALIZADO (mantido):
    ///      Usa UIInputUtils.IsTypingInInputField e IsPointerOverUI.
    ///
    ///   3. CACHE DE CÂMERA RESILIENTE (mantido):
    ///      _cam re-resolvido se for null em qualquer ponto.
    ///
    ///   4. CmdMoveTo COM SANITY EXTRA (mantido):
    ///      Checa NaN/Infinity nas coordenadas.
    /// </summary>
    ...
    public class NetworkPlayerController : NetworkBehaviour
    {
        ...
        public override void OnStartLocalPlayer()
        {
            ...
            // Configuração de NavMeshAgent vinda de GameConstants.Movement
            if (_agent != null)
            {
